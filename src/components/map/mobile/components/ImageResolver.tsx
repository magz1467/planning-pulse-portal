...
export const ImageResolver = ({ imageMapUrl, image, title, applicationId, coordinates }: ImageResolverProps) => {
  ...
  const generateMapboxUrl = (coords: [number, number]) => {
    ...
    return `https://api.mapbox.com/styles/v1/mapbox/satellite-v9/static/${lng},${lat},17,45,60/800x600@2x?access_token=${import.meta.env.VITE_MAPBOX_TOKEN}&logo=false`;
  };
