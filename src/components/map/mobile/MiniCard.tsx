...
export const MiniCard = ({ application, onClick }: MiniCardProps) => {
  ...
  return (
    <div 
      className="fixed bottom-4 left-4 right-4 bg-white rounded-lg shadow-xl cursor-pointer animate-in slide-in-from-bottom duration-300"
      onClick={onClick}
      style={{ zIndex: 1500 }}
    >
      <div className="border-b py-2 px-4 bg-white flex justify-between items-center">
