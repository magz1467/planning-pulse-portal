        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-col lg:flex-row items-start gap-12">
              <div className="w-full lg:w-1/2 space-y-6 animate-[slide-up_0.5s_ease-out] order-2 lg:order-1">
              ...
              <div className="lg:w-1/2 animate-[slide-up_0.7s_ease-out] order-1 lg:order-2">
                <Image
